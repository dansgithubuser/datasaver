"""
Django settings for datasaver_proj project.
...
INSTALLED_APPS = [
    'datasaver.apps.DatasaverConfig',
...
ROOT_URLCONF = 'datasaver_proj.urls'
...
WSGI_APPLICATION = 'datasaver_proj.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'datasaver_database',
        'USER': 'datasaver_user',
        'PASSWORD': os.environ.get('DATASAVER_DATABASE_PASSWORD', 'dev-password'),
        'HOST': '127.0.0.1',
        'PORT': '5432',
    }
}
